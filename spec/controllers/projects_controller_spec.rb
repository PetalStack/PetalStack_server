...
RSpec.describe ProjectsController, type: :controller do
  ...
  let(:valid_attributes) {
    skip(Builders::ProjectBuilder.new.build)
  }

  let(:invalid_attributes) {
    skip(Builders::ProjectBuilder.new.paramTitle('').build)
  }
  ...
  describe "GET #show" do
    ...
    context "with valid params" do
      it "creates a new Project" do
        expect {
          post :create, params: {project: Builders::ProjectBuilder.new.getObjProject }, session: valid_session
